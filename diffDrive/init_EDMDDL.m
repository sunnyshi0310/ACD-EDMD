function [K,Wout,bout,W0,W1,W2,b0,b1,b2,delta_phi] = init_EDMDDL(Ts, nx, nu, INPUTS)

M = 1000;
l_k = 5; %00 length for estimation 
...
for i = 1:M
    ...
    u_hat(:,1) = INPUTS(1,i,1); 
    u_hat(2,1) = INPUTS(2,i,1);
    
    for j = 1:l_k-1
        x_test(:,(i-1)*l_k+j+1) = diffDriveDT(x_test(:,(i-1)*l_k+j),u_hat(:,j),Ts);  
